...
TASK = ROOT / "28_TUT2017_full6300_rerun" / "selector"
...
def main(ds):
    ...
    source = ROOT / "28_TUT2017_full6300_rerun" / "cache" / ds
    runtime = load_module(Path(__file__).parent / "runtime" / ds / "runtime.py"); device = runtime.DEVICE
    ...
    protocol={"only_changed_variable":"relation selection", "text":"AAKV for every method", "fusion":"hierarchical NormLSE",
              ...
              "frequency5":frequency5,"random_seeds":[42,43,44],"dataset_partition":"TUT2017 development (4680) + evaluation (1620)","n_samples":len(samples),"selection_counts":{m:dict(c) for m,c in counts.items()}}
