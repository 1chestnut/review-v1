...
FSD_DIR = '/data/zkx/zkx/iknow-audio/data/FSD50K-1'
...
def load_dataset():
    ...
    return {'df': eval_df, 'label_classes': label_classes, 'kg_classes': kg_classes, 'class_labels_set': {name.lower() for name in label_classes}, 'class_to_idx': class_to_idx, 'total': len(eval_df)}
